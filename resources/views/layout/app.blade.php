    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse justify-content-center" id="navbarTogglerDemo01">
        <ul class="navbar-nav mx-auto">
          <li class="nav-item">
            <a class="nav-link {{ ($title === 'Home admin') ? 'active' : '' }}" aria-current="page" href="/homeAdmin">Home</a>
          </li>
          <li class="nav-item">
            <a class="nav-link {{ ($title === 'DokterAdmin') ? 'active' : '' }}" href="DokterAdmin">Dokter</a>
          </li>
          <li class="nav-item">
            <a class="nav-link {{ ($title === 'TambahHewan') ? 'active' : '' }}" href="HewanAdmin">Hewan</a>
          </li>
          <li class="nav-item">
            <a class="nav-link {{ ($title === 'KelolahReservasi') ? 'active' : '' }}" href="KelolahReservasi">Riwayat</a>
          </li>
          <li class="nav-item">
            <a class="nav-link {{ ($title === 'KelolahPemabayaran') ? 'active' : '' }}" href="KelolahPembayaran">Pembayaran</a>
          </li>
        </ul>
